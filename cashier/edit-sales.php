...
$purchaserecord = $_GET['sales'];
global $purchaserecord;
$purchases = "SELECT * FROM `sales` WHERE `sales_id` = '$purchaserecord'";
...
if ($purchasesrows >= 1) {
    ...
    $supplier = $fetch['sales_customer_id'];
        ...
        $globalquantity = $fetch['sales_quantity'];
        $globalunitprice = $fetch['sales_product_unit_price'];
        $globalreturns = $fetch['sales_returns'];
        $tamount = $fetch['sales_total_amount'];
        $globaldate = $fetch['sales_date'];
        $purchaseid = $fetch['sales_id'];
                                            ...
                                            <div class="sbp-preview-content">
                                                <form method="POST" action="">
                                                    ...
                                                    if (isset($_POST["addsales"])) {
                                                        ...
                                                        require 'functions/edit-sales.php';
                                                    }
                                                    ?>
                                                    <?php echo $message; ?>
                                                    <div class="row">
                                                    ...
                                                    <br>
                                                    <input type="hidden" name="salesrecord" value="<?php echo $purchaserecord; ?>">
                                                    <button class="btn btn-primary btn-sm" type="submit" name="addsales">Update New Sales</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
