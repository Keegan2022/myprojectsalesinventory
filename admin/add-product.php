...
include 'admin.php';
?>
<?php $batch_number = $unit_price = $product_quantity = $description = $product_name  = $message = ''; ?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <form method="POST" action="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control" id="exampleFormControlSelect2" name="product_subcategory">
                                                                    ...
                                                                    <option value="Maize Floor">Maize Floor</option>
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <input class="form-control" id="exampleFormControlInput1" type="number" placeholder="" name="quantity" value="<?php echo $product_quantity; ?>" />
                                                        </div>
